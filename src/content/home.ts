...
const de: HomeContent = {
  ...
  people: {
    ...
    body: 'A&C Consulting wird von Ricardo Caires und Octavio Nuno Gouveia Andrade geführt. Beide betreuen Mandate selbst.',
    members: [
      { name: 'Ricardo Caires', role: 'Mitinhaber' },
      { name: 'Octavio Nuno Gouveia Andrade', role: 'Geschäftsführer und Mitinhaber' },
    ],
    detail: 'Ricardo Caires ist zuständig für Treuhand, Steuern und Versicherungen, Octavio Nuno Gouveia Andrade für Versicherungen. Beide beraten auf Deutsch, Französisch, Portugiesisch und Englisch.',
