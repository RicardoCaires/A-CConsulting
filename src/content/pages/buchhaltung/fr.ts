...
/**
 * /fr/fiduciaire/comptabilite — franzoesische Fassung der Pilotseite.
 *
 ...
 * („Comptabilité"), weil eine Seite ohne `h1` kaputt waere. Die Marke steht
 * daneben.
 *
 * Die Icons sind keine Uebersetzungsfrage und darum gesetzt.
 */
export const buchhaltungFr: Leistungsseite = {
  slug: 'buchhaltung',
  locale: 'fr',
  bereich: 'treuhand',
