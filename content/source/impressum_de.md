...
Entwurf vom 09.09.2026.

Pflichtangaben. Sie werden nie umformuliert und nie automatisch geändert —
Änderungen ausschliesslich auf ausdrückliche Anweisung von Ricardo.

Die Adresse steht hier nicht ausgeschrieben. Sie kommt als Verweis aus
`src/lib/company.ts` und ist im Impressum der **Sitz laut Handelsregister**,
nicht die Büroadresse. Solange das Register Lyss führt, steht dort Lyss — auch
nach dem Umzug des Büros nach Aegerten.
...
Beschreibung: Pflichtangaben der A&C Consulting GmbH: Firma, Sitz, Handelsregister, FINMA-Registrierung und Kontakt.
...
Untertitel: Angaben nach Artikel 3 des Bundesgesetzes gegen den unlauteren Wettbewerb.

---

## 01 Verantwortlich für diese Website

A&C Consulting GmbH

Gesellschaft mit beschränkter Haftung, eingetragen im Handelsregister des Kantons Bern.

UID und Handelsregisternummer: CHE-332.960.986

---

## 02 Kontakt

Telefon und E-Mail stehen im Fussbereich jeder Seite und auf der Kontaktseite.
